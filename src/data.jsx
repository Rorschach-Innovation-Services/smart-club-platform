...
/* ─── Known previous clubs · onboarding quick-pick ───
   These clubs have been on Dolphins / KZNCU records in past seasons but
   haven't yet onboarded onto the 2026/27 platform. The admin can click any
   row in the Onboard New Club modal to pre-fill chair + contact + district.
   Typing an existing email or cell into the form also auto-matches against
   this list and pre-fills the rest. */
export const KNOWN_CLUBS = [
  { name: "Pinetown Cricket Club",     chair: "Sipho Khumalo",     chairEmail: "sipho@pinetowncc.co.za",  chairCell: "082 481 7211", district: "Ethekwini Metro Cricket Union" },
  { name: "Westville CC",              chair: "Rohan Pillay",      chairEmail: "rohan@westvillecc.co.za", chairCell: "083 552 9043", district: "Ethekwini Metro Cricket Union" },
  { name: "Glenwood Old Boys CC",      chair: "Michael Bekker",    chairEmail: "chair@globcc.co.za",      chairCell: "082 776 4318", district: "Ethekwini Metro Cricket Union" },
  { name: "Stamford Hill Stars CC",    chair: "Lerato Dlamini",    chairEmail: "lerato@stamfordstars.co.za", chairCell: "079 224 8810", district: "Ethekwini Metro Cricket Union" },
  { name: "Inanda Sporting CC",        chair: "Mandla Zungu",      chairEmail: "mandla@inandacc.co.za",   chairCell: "071 318 5562", district: "Ethekwini Metro Cricket Union" },
  { name: "Pietermaritzburg CC",       chair: "Devon Naicker",     chairEmail: "devon@pmbcc.co.za",       chairCell: "082 014 7233", district: "Ethekwini Metro Cricket Union" },
  { name: "Richards Bay CC",           chair: "Themba Mthembu",    chairEmail: "themba@rbcc.co.za",       chairCell: "083 919 4422", district: "Umkhanyakude Cricket District" },
  { name: "Empangeni Stars CC",        chair: "Bonga Nkosi",       chairEmail: "bonga@empangenicc.co.za", chairCell: "076 884 2371", district: "KCCD" },
  { name: "Port Shepstone CC",         chair: "Anand Pather",      chairEmail: "anand@portshepcc.co.za",  chairCell: "082 663 5519", district: "Ugu Cricket District" },
  { name: "Margate CC",                chair: "Trevor Knight",     chairEmail: "trevor@margatecc.co.za",  chairCell: "083 117 9088", district: "Ugu Cricket District" },
  { name: "KwaDukuza United CC",       chair: "Sandile Maphumulo", chairEmail: "sandile@kwadukucc.co.za", chairCell: "079 502 6644", district: "Illembe Cricket District" },
  { name: "Stanger Cricket Club",      chair: "Yashvir Maharaj",   chairEmail: "yash@stangercc.co.za",    chairCell: "082 998 3145", district: "Illembe Cricket District" },
];
